...
const plans = [
  {
    name: "Starter",
    tagline: "Launch a clean, credible presence",
    price: "₹24,999",
    period: "one-time",
    badge: "Best for solo brands",
    features: [
      "Up to 5 pages",
  ...
  {
    name: "Business",
    tagline: "Built to generate leads, not just look good",
    price: "₹59,999",
    period: "one-time",
    badge: "Most popular",
    features: [
      "Up to 12 custom pages",
      "Lead-gen funnels & landing pages",
      "Blog / CMS setup",
      "Advanced SEO + schema",
      "Google Analytics + Pixel setup",
      "Speed-optimised (90+ Lighthouse)",
  ...
  {
    name: "Premium",
    tagline: "Full-stack web platform for serious scale",
    price: "₹1,49,999+",
    period: "starting",
    badge: "Enterprise grade",
    features: [
      "Custom web app / SaaS dashboard",
      "User authentication & roles",
      "CRM / payments / API integrations",
      "Admin panel + automations",
